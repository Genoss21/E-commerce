    ...
    <!--Discounts-->
        ...
        <div class="w-full bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900">
            <div class="relative flex flex-wrap max-w-screen-2xl mx-auto justify-between items-center md:py-3 py-4 md:px-0 px-4">
                ...
                <!-- Main navbar -->
                <div id="product-menu-full" class="items-center justify-between font-medium hidden w-full md:flex md:w-auto md:order-1 z-50">
                    ...
                    <ul class="flex flex-col lg:gap-7 gap-2 p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 overflow-y-auto max-h-[666px]">
