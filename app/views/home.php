    ...
    <nav class="sticky top-0 bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900 z-10">
        <div class="relative flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl py-4 md:px-0 px-4">
            ...
            <div class="">
                ...
                <button data-collapse-toggle="search-sm" type="button" class="p-2 rounded-lg text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 md:hidden">
            ...
            <div id="search-sm" class="mt-4 items-center justify-between font-medium hidden w-full md:flex md:w-auto md:order-1 md:hidden">
            ...
            <div id="product-menu-full" class="items-center justify-between font-medium hidden w-full md:flex md:w-auto md:order-1">
                <ul class="flex flex-col gap-7 p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li class="md:hidden flex justify-center">
                        <!--Small screen button for Country-->
                        <button type="button" data-dropdown-toggle="language-dropdown-menu-small" class="inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                        ...
                        <!-- Dropdown -->
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700" id="language-dropdown-menu-small">
                    ...
                    <li>
                        <button id="product-menuButton" data-dropdown-toggle="product-menu" data-dropdown-delay="500" data-dropdown-trigger="hover" class="flex items-center justify-between w-full text-gray-900 rounded-sm md:w-auto hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">
                            Product
                        </button>
                    </li>
                    <li>
                        <button id="support-menuButton" data-dropdown-toggle="support-menu" data-dropdown-delay="500" data-dropdown-trigger="hover" class="flex items-center justify-between w-full text-gray-900 rounded-sm md:w-auto hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">
                            Support
                        </button>
                    </li>
                    <li><a href="#" class="block text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Blog</a></li>
                    ...
                    <li><a href="#" class="block text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Deals</a></li>
        ...
        <!--Product mega menu-->
        <div id="product-menu" class="absolute w-full border-gray-200 shadow-xs bg-gray-50 md:bg-white border-y dark:bg-gray-800 dark:border-gray-600 hidden z-10">
        ...
        <div id="support-menu" class="absolute w-full border-gray-200 shadow-xs bg-gray-50 md:bg-white border-y dark:bg-gray-800 dark:border-gray-600 hidden z-10">
            ...
            <div class="relative flex transition-transform duration-500 ease-in-out" id="carousel-container">
                <?php foreach ($data['featuredProducts'] as $product): ?>
                    <div class="carousel-item min-w-full flex-shrink-0">
                        <a href="">
                            <img src="<?= '/public' . $product['product_image_file'] ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="w-auto h-[833px] object-cover">
                        </a>
                ...
                <div class="carousel-item min-w-full flex-shrink-0">
                    <a href="">
                        <img src="<?= '/public' . $data['featuredProducts'][0]['product_image_file'] ?>" alt="<?= htmlspecialchars($data['featuredProducts'][0]['name']) ?>" class="w-auto h-[833px] object-cover">
                    </a>
